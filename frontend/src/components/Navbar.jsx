...
export default function Navbar() {
  ...
  return (
    <>
        {/* 
              Light Green (Highlights, Clicked Buttons)       - #fbfff9
              Neutral Green (Base Color)                      - #eaf5e4
              Dark Green (Clicked Effeect, Border Color)      - #869a7b
              */}
              ...
              <div className="hidden lg:flex items-center ml-auto">
                ...
                <NavLink
                  ...
                  `px-3 py-2 flex items-center rounded-full ${
                    isActive
                    ? "bg-[#ffffff] text-gray-900 border border-[#8ab473] border-1 shadow-lg hover:shadow-xl active:shadow-none transition-shadow duration-200"
                ...
                <button
                  ...
                  className="px-3 py-2 flex bg-[#d5f9c5] justify-center items-center border border-[#869a7b] rounded-full text-[#0b3115] hover:border-[#187832] hover:text-[#35573e] hover:bg-[#b1e6b7]"
                >
                ...
                <button
                  ...
                  className="px-3 py-2 flex bg-[#f9dcb8] border border-[#ba5719] rounded-full text-[#ba5719] hover:border-[#8c4420] hover:text-[#8c4420] hover:bg-[#ffc784]"
                >
