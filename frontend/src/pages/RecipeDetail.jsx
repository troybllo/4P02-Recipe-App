...
export default function RecipeDetail() {
  ...
  const fetchRecipe = async () => {
    const userId = localStorage.getItem("viewedRecipeUserId") || "Si25FjkxKL3agn2MUTlB";

    console.log("Trying to fetch recipe:", postId, "with userId:", userId); // ✅ DEBUG
  
    if (!userId) {
      toast.error("Missing userId for recipe. Cannot load.");
      return;
    }
    ...
    try {
      ...
      console.log("Recipe data returned:", data); // ✅ DEBUG
