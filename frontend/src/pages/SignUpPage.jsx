  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        triggerPopup(`Sign up failed`, `error`);
      }
    } catch (err) {
      ...
      <div className="max-w-md w-full bg-white rounded-xl shadow-2xl overflow-hidden">
        ...
        <div className="px-6 py-8 sm:px-10">
          <div className="text-center mb-10">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-1">Join Feastly!</h1>
            <p className="text-gray-600">Sign up to access all the features!</p>
          </div>
