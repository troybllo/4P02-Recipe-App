...
export const bio =
  "I love healthy foods for my bouldering training. I also love to cook and bake. I'm a software engineer by day and a chef by night.";
          ...
          <div className="flex items-center border-b-2 py-5">
            <div className="items-center justify-center mr-5">
              ...
              <button onClick={() => setIsEditProfileOpen(true)}>
                <p className="border-2 border-gray-300 rounded-full px-4 py-1 mt-3 text-xs justify-center items-center">
                  Edit Profile
                </p>
              </button>
            </div>
